...
$faqs = [
    ...
    'remove' => [
        ...
        'text' => "I risultati di ricerca di Google rispecchiano i contenuti pubblicamente disponibili sul Web.
         ...
         Se desideri rimuovere qualcosa dal Web, devi contattare il webmaster del sito su cui sono pubblicati i contenuti e chiedergli di apportare una modifica. ù
         Inoltre, se, ai sensi delle leggi europee per la protezione dei dati, 
         desideri richiedere la rimozione di determinate informazioni su di te visualizzate nei risultati di ricerca di Google, fai clic qui. 
    ...
    'search' => [
        ...
        'text' => "In alcuni casi sì. Quando fai clic su un risultato della Ricerca Google,
         ...
         Ulteriori informazioni sulla ricerca SSL sono disponibili qui. Le query di ricerca o le informazioni contenute 
